...
/*   Updated: 2023/10/01 14:18:05 by rnaito           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_map(t_scene *scene)
{
	...
	scene->ambient.lighting_ratio = 0.8;
	...
	sphere2->color.red = 242;
	sphere2->color.green = 183;
	sphere2->color.blue = 232;
